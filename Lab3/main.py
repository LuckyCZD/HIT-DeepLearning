...
def test_csv(model, loader, use_gpu):
    ...
    name = [['Black-grass'], ['Charlock'], ['Cleavers'], ['Common Chickweed'], ['Common wheat'], ['Fat Hen'],
            ...
            ['Sugar beet']]
    with open('predict2.csv', 'w', encoding='utf-8', newline='') as f:
        writer = csv.writer(f)
...
if __name__ == '__main__':
    ...
    #
    # # 保存模型和优化器的参数
    # torch.save({'model_state_dict': model.state_dict(), 'optimizer_state_dict': optimizer.state_dict(),}, 'ResNet+SEBlock.pth')
    #
