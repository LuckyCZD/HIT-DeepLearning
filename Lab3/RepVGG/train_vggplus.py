...
from models.repvggplus import create_RepVGGplus_L2pse
...
if __name__ == '__main__':
    #创建保存模型的文件夹
    file_dir = 'checkpoints/RepVggPlus'
    ...
    transform = transforms.Compose([
        ...
        transforms.RandomCrop(224,padding=(64,0)),
        transforms.ToTensor(),
    ...
    #设置模型
    model_ft = create_RepVGGplus_L2pse(deploy=False)
    print(model_ft)
    ...
    if resume:
        ...
        model_ft.classifier[3] = nn.Linear(num_ftrs, classes)
    model_ft.to(DEVICE)

    # 选择简单暴力的Adam优化器，学习率调低
    optimizer = sgd_optimizer(model_ft, args.lr, args.momentum, args.weight_decay, args.custwd)
